...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Welcome to the bus fare ticketing kiosk. Would you like to buy a fare card? (Yes/No)");
    ...
    private static void createTicket() {
        ...
        System.out.print("Would you like to load a fare onto your card? (Yes/No)");
